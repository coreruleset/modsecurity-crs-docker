...
* nginx – *latest stable ModSecurity v3 on Nginx 1.28.0 official stable base image, and latest stable OWASP CRS 4.16.0*
...
* Apache httpd – *last stable ModSecurity v2 on Apache 2.4.65 official stable base image, and latest stable OWASP CRS 4.16.0*
