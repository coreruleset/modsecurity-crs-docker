...
* nginx – *latest stable ModSecurity v3 on Nginx 1.30.3 official stable base image, and latest stable OWASP CRS 4.28.0*
...
* Apache httpd – *last stable ModSecurity v2 on Apache 2.4.68 official stable base image, and latest stable OWASP CRS 4.28.0*
